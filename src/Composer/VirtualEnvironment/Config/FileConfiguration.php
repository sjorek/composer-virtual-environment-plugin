...
class FileConfiguration extends AbstractConfiguration implements FileConfigurationInterface
{
    ...
    const INFO = 'Virtual environment configuration file generated by the composer-virtual-environment-plugin';

    /**
     * @param Composer $composer
     * @param string   $filename
     */
    public function __construct(Composer $composer, $filename)
    {
    ...
    /**
     * {@inheritDoc}
     * @see \Sjorek\Composer\VirtualEnvironment\Config\FileConfigurationInterface::load()
     */
    ...
    /**
     * {@inheritDoc}
     * @see \Sjorek\Composer\VirtualEnvironment\Config\FileConfigurationInterface::save()
     */
    public function save($force = false)
    {
        if ($this->dirty || $force) {
            ...
            $result = file_put_contents($this->filename, $json . PHP_EOL);
            if ($result === false) {
                return false;
            }
            $this->dirty = false;
